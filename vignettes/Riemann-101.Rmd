...
## What You Need to Do : Wrap the Data
...
```{r message=FALSE, warning=FALSE, fig.align='center', fig.width=6, fig.cap="60 Populated Cities in the US"}
...
mycities = usmap_transform(dfcities)

# visualize
myplot <- plot_usmap(regions="states", exclude=c("AK")) + 
...
```{r message=FALSE, warning=FALSE, fig.align='center', fig.width=6, fig.cap="Populated Cities and Central Locations."}
...
vismean = usmap_transform(dfmeans)
...
From the plot above, we can observe that **\textcolor{blue}{geometric}** center is right next to Wichita, KS whereas **\textcolor{red}{euclidean}** center of locations is a bit deviated, lying between Wichita and Albuquerque, NM. 